								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"> Kelola Pasien</h2>
...
{
?>
											Total Pasien :<?php echo htmlentities($num_rows);  } ?>		
												</a>
											</p>
										</div>
									</div>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Kelola Dokter</h2>
...
{
?>
											Total Dokter :<?php echo htmlentities($num_rows1);  } ?>		
												</a>
