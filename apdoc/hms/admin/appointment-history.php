...
<html lang="en">
	<head>
		<title>Pasien | Appointment History</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Pasien  | Appointment History</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Pasien </span>
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												<th class="center">#</th>
												<th class="hidden-xs">Nama Dokter</th>
												<th>Nama Pasien</th>
												<th>Spesialisasi</th>
												<th>Biaya Konsultasi</th>
												<th>Tanggal/Waktu Appoinment</th>
												<th>Waktu Pembuatan Appointment</th>
												<th>Status</th>
												<th>Aksi</th>
