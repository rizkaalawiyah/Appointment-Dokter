...
if(isset($_GET['cancel']))
		  {
                  ...
                  $_SESSION['msg']="Appointment dicancel !!";
		  }
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<title>Dokter | Appointment History</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Dokter  | Appointment History</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Dokter </span>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												...
												<th>Waktu/Tanggal Appointment </th>
												<th>Tanggal dibuat Appointment</th>
