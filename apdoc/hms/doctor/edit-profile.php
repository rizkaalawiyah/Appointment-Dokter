...
<html lang="en">
	<head>
		<title>Dokter | Ubah Dokter Detail</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Dokter | Ubah Dokter Detail</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Dokter</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Edit Dokter</h5>
												</div>
